...
public enum TrimAbility {
    ...
    VEX("Vex", Material.VEX_ARMOR_TRIM_SMITHING_TEMPLATE, "Totem activations grant Strength and Speed and extend Fire Resistance",
            level("strength-level", "Strength level", 2), level("speed-level", "Speed level", 2),
            decimal("duration-seconds", "Strength and Speed seconds", 90, .1, 600, .5, 5),
            decimal("fire-resistance-duration-seconds", "Totem Fire Resistance seconds", 90, .1, 600, .5, 5)),
    ...
    EYE("Eye", Material.EYE_ARMOR_TRIM_SMITHING_TEMPLATE,
            "Stare at a player for Weakness and Glowing; sneak for Slowness",
            level("weakness-level", "Stare Weakness level", 1),
            level("slowness-level", "Sneak Slowness level", 1),
            integer("glowing-enabled", "Stare Glowing (1=on, 0=off)", 1, 0, 1, 1, 1)),
    ...
    RAISER("Raiser", Material.RAISER_ARMOR_TRIM_SMITHING_TEMPLATE, "Permanent Jump Boost and increased step height",
            level("jump-boost-level", "Jump Boost level", 2),
            decimal("step-height-bonus", "Step height bonus", .6, 0, 10, .05, .25)),
