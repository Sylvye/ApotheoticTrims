...
public enum TrimAbility {
    ...
    COAST("Coast", Material.COAST_ARMOR_TRIM_SMITHING_TEMPLATE, "Permanent Luck",
    ...
    BOLT("Bolt", Material.BOLT_ARMOR_TRIM_SMITHING_TEMPLATE, "Melee combos call down weak lightning",
            integer("combo-hits", "Combo hits", 10, 1, 1000, 1, 10),
            decimal("timeout-seconds", "Timeout seconds", 5, .1, 600, .5, 5),
            decimal("lightning-damage", "Lightning damage", 16, 0, 100, .5, 2)),
    ...
    RIB("Rib", Material.RIB_ARMOR_TRIM_SMITHING_TEMPLATE, "Permanent Fire Resistance",
            level("fire-resistance-level", "Fire Resistance level", 1)),
    ...
    EYE("Eye", Material.EYE_ARMOR_TRIM_SMITHING_TEMPLATE, "Sneaking makes nearby players glow",
            decimal("radius", "Radius", 10, 0, 64, .5, 2),
            decimal("glow-seconds", "Glow seconds", 15, .1, 600, .5, 5)),
    ...
    HOST("Host", Material.HOST_ARMOR_TRIM_SMITHING_TEMPLATE, "Permanent Hero of the Village",
